...
describe('serializeAss', () => {
      ...
      styles: [
        {
          ...
          fontName: 'Arial',
          fontSize: 28,
          primaryColor: assColorFromHex('#FFFFFF'),
          secondaryColor: assColorFromHex('#808080'),
          outlineColor: assColorFromHex('#000000'),
          backColor: assColorFromHex('#000000', 0),
          shadow: 0,
          alignment: 2,
          marginLeft: 10,
          marginRight: 10,
  ...
  it('preserves the input order of multiple styles and events', () => {
    const document = makeDocument({
      styles: [
        ...
        },
        {
          ...
          fontName: 'Arial',
          fontSize: 24,
          primaryColor: assColorFromHex('#C0C0C0'),
          secondaryColor: assColorFromHex('#808080'),
          outlineColor: assColorFromHex('#000000'),
          backColor: assColorFromHex('#000000', 0),
          shadow: 0,
    ...
    expect(text.indexOf('Dialogue: 0,0:00:00.00,0:00:01.00,Lyrics,,0,0,0,,one')).toBeLessThan(
      text.indexOf('Dialogue: -1,0:00:00.00,0:00:01.00,Preview,,0,0,0,,two'),
    );
  });
